...
| ------ | ------ | ----- | ----- |
| Validation | Innovators and early adopters | Product Market Fit |  unit testing <br> code reviews <br> building pipelines <br> dogfooding [^1] <br> Automation: little to none  |
...
##### dogfooding
[^1]: Using one's own products internally
